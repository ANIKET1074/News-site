...
<div id="main-content">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    $offset = ($page - 1) * $limit;
                    $sql = "SELECT post.post_id,post.category,post.title,post.description,post.post_img,post.post_date,category.category_name,user.username FROM `post` 
    LEFT JOIN category ON post.category = category.category_id  
    ...
    <li><a href="">3</a></li>
                    ...
                    $sql1 = "SELECT * FROM post WHERE author=$auth_id";
                    ...
                    if (mysqli_num_rows($result1) > 0) {
                        ...
                        if ($page > 1) {
                            echo '<li><a href="author.php?aid=' . $auth_id . '&page=' . ($page - 1) . '">Pre</a></li>';
                        }
