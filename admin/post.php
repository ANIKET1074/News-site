    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                // Here we are joining two tables user and category with the post table .
                // we join the category table , category-id  with post , cateogory and user , user_id with post , author 
                // $sql = "SELECT post.post_id,post.title,post.description,post.post_date,category.category_name,user.username FROM `post` 
                // LEFT JOIN category ON post.category = category.category_id  
                // LEFT JOIN user ON post.author = user.user_id
                // ORDER BY `post_id` LIMIT $offset,$limit";
